...
class TradingManager{
   ...
   void PrepairMbfx(){
      ...
      */
      ...
      ArrayResize(glArray_extreme_or_delta_enable,0);
      TM.AddInArray(glArray_extreme_or_delta_enable, extreme_or_delta_enable_m1);
      TM.AddInArray(glArray_extreme_or_delta_enable, extreme_or_delta_enable_m5);
      TM.AddInArray(glArray_extreme_or_delta_enable, extreme_or_delta_enable_m15);
      TM.AddInArray(glArray_extreme_or_delta_enable, false);  // M30 is ignored per spec
      TM.AddInArray(glArray_extreme_or_delta_enable, extreme_or_delta_enable_h1);
      TM.AddInArray(glArray_extreme_or_delta_enable, extreme_or_delta_enable_h4);
      TM.AddInArray(glArray_extreme_or_delta_enable, extreme_or_delta_enable_d1);
      TM.AddInArray(glArray_extreme_or_delta_enable, extreme_or_delta_enable_w1);
      TM.AddInArray(glArray_extreme_or_delta_enable, extreme_or_delta_enable_mn);
   }
