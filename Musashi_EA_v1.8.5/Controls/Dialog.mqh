...
public:
   ...
   virtual bool      FontSize(const int value) { return(m_caption.FontSize(value));    }
...
//--- coordinates
   ...
   int y1=off;
   int x2=Width()-off;
   int y2=y1+TRADE_PAD_CONTROLS_DIALOG_CAPTION_HEIGHT;
//--- create
...
bool CDialog::CreateButtonClose(void)
  {
   int off=(m_panel_flag) ? 0 : 2*CONTROLS_BORDER_WIDTH;
//--- coordinates
   int x1=Width()-off-(CONTROLS_BUTTON_SIZE+TRADE_PAD_CONTROLS_DIALOG_BUTTON_OFF);
   int y1=off+TRADE_PAD_CONTROLS_DIALOG_BUTTON_OFF;
...
//--- create
   ...
   if(!CWndContainer::Add(m_button_close))
      return(false);
   m_button_close.Alignment(WND_ALIGN_RIGHT,0,0,off+TRADE_PAD_CONTROLS_DIALOG_BUTTON_OFF,0);
//--- change caption
   CaptionAlignment(WND_ALIGN_WIDTH,off,0,off+(CONTROLS_BUTTON_SIZE+TRADE_PAD_CONTROLS_DIALOG_BUTTON_OFF),0);
//--- succeed
   return(true);
  }
//+------------------------------------------------------------------+
...
bool CDialog::CreateClientArea(void)
  {
   int off=(m_panel_flag) ? 0:2*CONTROLS_BORDER_WIDTH;
//--- coordinates
   int x1=off+TRADE_PAD_CONTROLS_DIALOG_CLIENT_OFF;
   int y1=off+TRADE_PAD_CONTROLS_DIALOG_CAPTION_HEIGHT;
   int x2=Width()-(off+TRADE_PAD_CONTROLS_DIALOG_CLIENT_OFF);
   int y2=Height()-(off+TRADE_PAD_CONTROLS_DIALOG_CLIENT_OFF);
//--- create
...
public:
   ...
   void              SetMinMaxState(const bool flag) { m_button_minmax.Pressed(flag); }
...
//--- geometry for the minimized state
   m_min_rect.SetBound(TRADE_PAD_CONTROLS_DIALOG_MINIMIZE_LEFT,
                       TRADE_PAD_CONTROLS_DIALOG_MINIMIZE_TOP,
                       TRADE_PAD_CONTROLS_DIALOG_MINIMIZE_LEFT+TRADE_PAD_CONTROLS_DIALOG_MINIMIZE_WIDTH,
                       TRADE_PAD_CONTROLS_DIALOG_MINIMIZE_TOP+TRADE_PAD_CONTROLS_DIALOG_MINIMIZE_HEIGHT);
...
//--- geometry for the minimized state
   ...
   m_min_rect.Height(TRADE_PAD_CONTROLS_DIALOG_MINIMIZE_HEIGHT-2*CONTROLS_BORDER_WIDTH);
//--- determine subwindow
...
//--- destroyed already?
   if(m_deinit_reason!=WRONG_VALUE)
      return;
//---
   TM.SaveStateAction(reason,HEAD_TO_STRING,true);
...
bool CAppDialog::CreateButtonMinMax(void)
  {
   int off=(m_panel_flag) ? 0:2*CONTROLS_BORDER_WIDTH;
//--- coordinates
   int x1=Width()-off-2*(CONTROLS_BUTTON_SIZE+TRADE_PAD_CONTROLS_DIALOG_BUTTON_OFF);
   int y1=off+TRADE_PAD_CONTROLS_DIALOG_BUTTON_OFF;
   int x2=x1+CONTROLS_BUTTON_SIZE;
   int y2=y1+CONTROLS_BUTTON_SIZE;
//--- create
   ...
   m_button_minmax.Alignment(WND_ALIGN_RIGHT,0,0,off+CONTROLS_BUTTON_SIZE+2*TRADE_PAD_CONTROLS_DIALOG_BUTTON_OFF,0);
//--- change caption
   CaptionAlignment(WND_ALIGN_WIDTH,off,0,off+2*(CONTROLS_BUTTON_SIZE+TRADE_PAD_CONTROLS_DIALOG_BUTTON_OFF),0);
//--- succeed
   return(true);
  }
//+------------------------------------------------------------------+
